      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 max-lg:gap-8 items-center">
        ...
        <div className="lg:col-span-5 space-y-8 px-2 w-full">
          <div className="space-y-4 w-full">
            ...
            <h1 className="text-4xl font-[Bodoni_Moda] md:text-6xl w-full  leading-tight">
            <p className="font-semibold ">  Inspiration for beautiful</p>
              <p className="italic text-[#E3C77A] font-[Playfair_Displa] "> interior designs</p>
            </h1>
            <p className="text-gray-400 leading-relaxed ">
              Lorem Ipsum has been the industry’s standard dummy text ever since
              the 1500s, when an unknown printer took a galley of type and
              scrambled it to make a type specimen book. Give your home a new
              look with these interior design ideas curated specifically for
